...
const lightCode = require('prism-react-renderer');
const lightCodeTheme = lightCode.themes.github;
const darkCode = require('prism-react-renderer');
const darkCodeTheme = darkCode.themes.dracula;
